...
# ! [FIXME]
folder_path = "/mnt/e/Datasets/TestDateset_BMCT/mel/"  # the path contain diff dirs store diff class mel spec
output_path = "/home/june_wsl/Workspace/Bidirectional-matching-cross-transfer/CDTrans/data/ShipsEar2DeepShip/target_list.txt"
